...
public class MainMenu {
    ...
    private final ManageToDoMenu manageToDoMenu;
    ...
    public MainMenu(OutputStream out, InputStream in) {
        ...
        inputHandler.addAction("Create&Load ToDo List",
                () -> manageToDoMenu.openCreate());
        inputHandler.addAction("Load ToDo List from file",
                () -> manageToDoMenu.openLoad());
        inputHandler.addAction("Delete ToDO List", null);
        inputHandler.addAction("Quit",
