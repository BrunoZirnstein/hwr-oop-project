...
public class MainMenu extends InputOptionsMenu {
    ...
    private void createSimpleTask() {
        ...
        CreateTaskCommand createTaskCommand = new CreateTaskCommand(Main.activeTodo().id(), taskName, null, null, null,
                null, null);
    ...
    private void createTask() {
        ...
        TaskPriority priority = Console.promptForEnum(TaskPriority.class, out, in, false, false, msg,
                CREATE_TASK_PRIORITY_ERROR_MSG);

        msg = String.format(CREATE_TASK_STATUS_MSG_PREFIX, Arrays.toString(TaskStatus.values()));
        TaskStatus status = Console.promptForEnum(TaskStatus.class, out, in, false, false, msg,
                CREATE_TASK_STATUS_ERROR_MSG);

        CreateTaskCommand createTaskCommand = new CreateTaskCommand(Main.activeTodo().id(), taskName, description, null,
