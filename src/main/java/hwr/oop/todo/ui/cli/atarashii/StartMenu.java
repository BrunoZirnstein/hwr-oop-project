...
public class StartMenu extends InputOptionsMenu{
	...
	public final String loadOrCreateSucessMsgPrefix = "Sucess!: ";
...
//		}
		...
		out.println(loadOrCreateSucessMsgPrefix + todolistName + System.lineSeparator());
	...
	private void quitProgram() {
		//out.println("Selbsttestfehler. Ich hasse dich nicht.");
	}
