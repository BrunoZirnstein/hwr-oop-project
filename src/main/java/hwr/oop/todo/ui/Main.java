...
public class Main {
    ...
    public static final CreateProjectInPort CREATE_PROJECT_IN_PORT = new CreateProjectUseCase(PERSISTENCE_ADAPTER, PERSISTENCE_ADAPTER);
    public static final CreateTaskInPort CREATE_TASK_IN_PORT = new CreateTaskUseCase(PERSISTENCE_ADAPTER, PERSISTENCE_ADAPTER);
