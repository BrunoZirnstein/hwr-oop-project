...
public class ProjectMenu {
    ...
    public ProjectMenu(TodoMainMenu todoMainMenu, OutputStream out,
                       InputStream in) {
    ...
    private String promptProjectNameInput() {
        ...
        while (true) {
            ...
            if (!projectName.isEmpty()) {
                ...
                out.println(
                        "Invalid project name (empty). Please enter a valid project name!");
            }
        }
    }
    ...
    private LocalDate promptDeadlineInput() {
        out.println(
                "What's the deadline of the project? Format: YYYY-MM-DD (or leave blank)");
        ...
        while (true) {
            ...
            if (!deadlineStr.isEmpty()) {
                try {
                    ...
                    out.println(
                            "Invalid date format! Please enter the deadline in the Format: YYYY-MM-DD (or leave blank)");
                }
            } else {
                return null;
            }
