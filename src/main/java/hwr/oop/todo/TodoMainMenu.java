...
public class TodoMainMenu {
    ...
    public TodoMainMenu(MainMenu mainMenu, OutputStream out, InputStream in) {
        ...
        if (mainMenu == null) {
            throw new NullPointerException(
                    "the mainMenu parameter is invalid!");
        }
        ...
        inputHandler.addAction("Create Project",
                () -> projectMenu.openCreate());
        inputHandler.addAction("Delete Project", null);
        inputHandler.addAction("Create Tasks (quick create)",
    ...
    private void saveCSV() {
        ...
        out.println(
                "Saved ToDo: '" + Main.activeTodo.owner() + "' successfully.");
    }
}
