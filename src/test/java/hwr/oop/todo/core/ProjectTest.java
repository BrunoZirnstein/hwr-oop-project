...
class ProjectTest {
    ...
    void newProject() {
        Assertions.assertDoesNotThrow(
                () -> new Project.Builder("Test").build());
    ...
    void changeTitle_invalid() {
        Project project = new Project.Builder("Test").build();
        assertThatThrownBy(() -> project.setTitle("")).isInstanceOf(
    ...
    void idOfProject() {
        ...
        assertThat(id).isInstanceOf(ProjectId.class);
    }

    @Test
    @DisplayName("Changing deadline of project")
    void deadlineOfProject() {
        Project project = new Project.Builder("Test").deadline(
                LocalDate.of(2000, 1, 1)).build();
    ...
    @Test
    @DisplayName("Changing deadline of project invalid")
    void changeDeadline_invalid() {
        Project project = new Project.Builder("Test").deadline(
                LocalDate.of(2000, 1, 1)).build();
        assertThatThrownBy(
                () -> project.setDeadline(LocalDate.of(0, 0, 0))).isInstanceOf(
